...
export default function SessionsSection({
  ...
  const totalPages = useMemo(() => Math.max(1, Math.ceil(sessions.length / PAGE_SIZE)), [sessions]);
  ...
  return (
    <section className="max-w-[1200px] mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-navy-deep font-serif mb-10">{title}</h2>
