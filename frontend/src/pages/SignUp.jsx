        ...
        {isSigningUp ? (
          <div className="flex items-center gap-4 p-6 bg-navy-dark/40 border border-slate-800 rounded-2xl backdrop-blur-sm">
            <div className="flex -space-x-3">
              ...
              <div className="w-10 h-10 rounded-full border-2 border-navy-deep bg-primary flex items-center justify-center text-[10px] font-bold text-white"></div>
            </div>
            <div>
          ...
          <p className="text-slate-400 text-xl font-medium mb-12 max-w-md">
            Continue your mastery through teaching
          </p>
        )}
      </div>
